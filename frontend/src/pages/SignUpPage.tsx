...
export default function SignUpPage() {
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="hidden md:flex relative flex-col justify-between p-14 text-white overflow-hidden bg-gradient-to-br from-deep via-primary to-secondary">
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div className="leading-tight">
            ...
            <p className="font-mono text-[11px] tracking-wider text-white/65">
              PALIS ECO VEHICLES
            </p>
          </div>
        </div>
        <div className="relative z-10 max-w-md">
          <h1 className="text-4xl font-semibold leading-tight mb-4">
            Join your department&apos;s dashboard.
          </h1>
          <p className="text-white/80 text-[15px]">
            Create your account to start tracking targets and achievements
            alongside your team.
          </p>
        </div>
        <div />
      ...
      {/* Form panel — Clerk's real widget */}
          ...
          <SignUp
            ...
            appearance={{
              ...
              elements: {
                ...
                formButtonPrimary:
                  "bg-primary hover:bg-deep text-sm normal-case",
