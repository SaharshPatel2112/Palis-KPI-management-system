                ...
                <tbody className="divide-y divide-line">
                  {filtered.map((r, i) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-4">
                        <span className="font-mono text-[11px] font-medium tracking-wide bg-panel border border-line rounded px-2 py-1">
                          {r.role}
                        </span>
                      </td>
                      ...
                      <td className="px-4 py-4">
                        <div className="flex items-center gap-3">
                          <div className="flex-1 h-2 bg-panel rounded-full overflow-hidden border border-line/50">
                            <div
